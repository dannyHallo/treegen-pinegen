🌳 TREEGEN - Voxel Tree Generator
=================================

Treegen is a simple, standalone tool for generating beautiful procedural trees in the .vox format — perfect for Teardown, MagicaVoxel, or any voxel-based project.
